...
Con el objetivo de complementar el contenido de este informe y ver el avance de todo el plan de vacunación, cantidad de casos y fallecidos, nos pareció pertinente realizar una aplicación 'Shiny' de modo interactiva, en el cual se podrá elegir entre diferentes variables, dependiendo de cada pregunta y ver el avaance de las mismas. A continuación, detallaremos qué es lo que se encuentra en cada sección y cómo navegar en la aplicación:
