...
#
#si se puede incluir lo que agregue antes de la media, se podrían sacar mejores conclusiones creo
#
#se puede hacer para este caso, quedo pendiente de agregarlo -MARU
...
```
Con dicho gráficos, podemos observar que no se cumple lo que planteamos en la pregunta. Se puede observar que los 3 departamentos con mayór proporción de personas vacunadas con ambas dosis son:
