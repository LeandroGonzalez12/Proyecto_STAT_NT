...
Tal y cómo planteamos en la introducción, nuestro principal interés se encuentra en el plan de vacunación. Queremos saber cómo ha evolucionado en el correr del tiempo (recordar que el plan de vacunación *comenzó el 1ero de Marzo* de 2021), si las mismas fueron efectivas, los diferentes tipos de laboratorios proveedores de vacunas y demás.

Para comenzar este análisis, nos preguntamos cómo avanzó dicho plan y cuánta cantidad de vacunas han sido suministradas por cada laboratorio.
...
Observando detalladamente el gráfico, se puede apreciar que los días en que más dosis se suministraron fueron entre los primeros 15 días del mes de abril, período que incluyó la semana de turismo. En este lapso temporal se vacunó a población de un gran rango etario que iba desde los 18 años en adelante. Por otra parte, la vacuna elaborada por la empresa farmacéutica de orígen estadounidense, Pfizer, tuvo su pico en torno al 10 de abril, hecho que se explica por el comienzo del plan vacunatorio para gran parte de los trabajadores de la salud ; con excepción de los que trabajan en áreas de mayor urgencia, como por ejemplo: block quirúrgico, servicios de apoyo CTI, y demás, que fueron vacunados en marzo con Sinovac.
...
Asimismo, en segundo lugar, la del laboratorio Pfizer se ha aplicado a poblaciones mas específicas, como personal de salud y edades en las cuales aún no se habían realizado estudios con la china (Sinovac). Aproximadamente el 24% de las dosis suministradas fueron por Pfizer.
...
Se puede observar que toda la población (que se agendó para vacunarse, no a nivel país) se encuentra vacunada, mientras que más del 85% de la población se dio la 2da dosis.
...
Se puede apreciar que 229616 personas que se dieron la primera dosis antes del 26/05 no se dieron la segunda dosis de la vacuna en el Uruguay. Esto puede deberse a que esas más de 200000 personas no creen en la efectividad de la vacuna, no suelen vacunarse, pueden haberse contagiado de COVID-19 en ese lapso de tiempo, entre otras situaciones. 

*Ésta última cantidad de personas proviene de sumar ambos valores del gráfico y restárselo a la población de Uruguay (más de 3.300.000 de personas)*
...
Esto cambió rotundamente en el 2021, ya que a partir de ahí comenzó a haber un excesivo aumento de casos, ya sea por el verano que la gente empezó a salir con mayor frecuencia por lo que se "cuidó" menos, no hubo un gran manejo de la pandemia, o simplemente, al ser un virus tan contagioso y con la aparición de nuevas cepas (Alpha, Beta, Gamma, Delta), el mismo mutó y desencadenó una gran cantidad de contagios.
...
Desafortunadamente, y como era de esperarse, el virus ha dejado una gran cantidad de fallecidos en nuestra población, hecho muy lamentado. En el siguiente gráfico se aprecia la cantidad de fallecimientos por departamentos.
...
Por otra parte, Flores, que es el que departamento que menor población tiene (un poco más de 24000 personas) es el que tiene menor cantidad de fallecimientos y contagios. Por tanto, podemos decir que en este departamento estas dos cantidades se condicen con su población.
...
Con el objetivo de complementar el contenido de este informe, a la vez que presentarlo de una manera práctica e interactiva, llevamos a cabo el desarrollo de una aplicación shiny.

Dicha app se compone de la siguiente manera: al ingresar emerge una ventana que funciona como introducción y narra de que se trata la misma, además presenta a quienes la desarrollaron. Luego el contenido se dispone en 5 pestañas ubicadas verticalmente en el sector superior izquierdo de la pantalla.

La primera pestaña refiere a vacunación, en esta se puede ver un mapa de Uruguay en el cual al pasar el cursor por encima de cada departamento, se muestra la cantidad de personas que se han vacunado y cuantas de estas lo han hecho con ambas dosis.

En segundo lugar se muestra según el laboratorio elegido y el rango temporal seleccionado, un gráfico que representa la cantidad de dosis suministradas por cada día en todo el territorio nacional. Debajo de este se encuentra un gráfico de barras expresado en miles de dosis, con el total acumulado de dosis por laboratorio, en las fechas elegidas.
...
Por último se decide llevar a cabo una comparación a través de un gráfico de línea, de como ha evolucionado la cantidad de fallecidos en Uruguay a medida que el plan de vacunación avanza.



## Conclusiones

Al comienzo de dicho reporte, nos propusimos seguir el plan de vacunación. Como comentario general, la vacuna mayor aplicada fue la CoronaVac, del laboratorio Sinovac.
También nos propusimos investigar cómo dicho plan podría haber influido en la cantidad de casos positivos, fallecimientos, etc.
A partir del mes de Junio, la cantidad de casos positivos diarios ha ido disminuyendo, producto de dicho plan. A día de hoy, ya se alcanzaron los 2 millones de personas vacunadas con ambas dosis y si bien la situación sanitaria en Uruguay ha sido muy cambiante, según el Ministro de Salud Pública se observa una ['marcadísima incidencia del efecto de la vacuna en los nuevos casos, con un descenso abrupto'](https://ladiaria.com.uy/coronavirus/articulo/2021/7/salinas-aseguro-que-se-constato-una-marcadisima-incidencia-del-efecto-de-la-vacuna/).
Con respecto a la cantidad de fallecimientos diarios, pareciera que también vienen en descenso, pero no podríamos confirmarlo con los datos que tenemos actualizados hasta el 23/06.
Por esta razón, como posible extensión de este trabajo podría ser seguir la evolución mes a mes, para así poder seguir estudiando el avance de la pandemia.
Por último, podríamos realizar un modelo para poder predecir dicho avance.
